...
namespace MobEye.Controls
{
    public sealed class CustomEntry: Entry
    {
        ...
        public static BindableProperty InnerBackgroundColorProperty =
        BindableProperty.Create("InnerBackgroundColor", typeof(Color), typeof(CustomEntry), Color.Transparent);
